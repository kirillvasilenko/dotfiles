return {
  ...
  config = function()
    ...
    -- :mksession records the window layout; it cannot omit an open split.
    -- close_filetypes_on_save would drop Trouble from the file *by closing it
    -- in the current UI* — do not use that for gO. Leave it open on save;
    -- drop any restored Trouble window after load.
    local function close_trouble_windows()
